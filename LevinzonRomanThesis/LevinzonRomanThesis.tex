...
The current iteration of \appname provides a small amount of very straightforward challenges (or tests) where user can test his/her knowledge of one of the notebooks. \textbf{Challenges} section serves as an entry point for setting up these different tests.
...
Just like the Flashcards challenge, next test features a list of questions base on of the users' notebooks. The idea of Self-check challenge \ref{fig:challenge-self} is straightforward. Given a list of questions, the user must ask himself a simple question: do know the answer? Two buttons below the flashcard are then self-explanatory: It's the user answer, either he/she know the answer or not. Clicking will "I know" will reveal the next question and clicking "Study again" will reveal the answer to the current question.
