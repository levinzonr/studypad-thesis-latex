...
Retrofit also has support for some popular threading libraries like RxJava, and recently -- Kotlin coroutines.
...
Threading and background work has always been a problem in the world of Android development.  Google provided some tools and APIs to solve this problem: AsyncTasks and Loaders. Both of them got a lot of issues, mainly because they were not very intuitive and flexible to use. AsyncTask specifically, when not used properly, was the main cause for memory leaks.
...
\begin{figure}
	...
	\includegraphics[scale=0.54]{navigationeditor}
...
ViewModels, Interactors,  Repositories, and Fragments and Activities.
...
Listing \ref{code:repo} demonstrates implementation of th \texttt{getNotebooks()} function, which is marked as suspend. This allows using all the power of the Kotlin Coroutines. Retrofit got a Kotlin Coroutines support, allowing to use generic  \texttt{Deffered} class as a return type, that is then used to wait for the result.
...
\subsection{Present the data in Fragments}
