...
\appname\ has its own REST API is represented by Spring Boot application. The Spring Framework is an application framework and inversion of control container for the Java platform. The framework's core features can be used by any Java application, but there are extensions for building web applications on top of the Java EE (Enterprise Edition) platform. 
...
\section{Firebase}
Firebase is Google's mobile platform that helps to quickly develop high-quality applications and grow businesses. Firebase provides a high number of services, some of which are a necessity in today's world of software development. \\\appname\ will be using the following services:
\begin{itemize}
...
This chapter describes how \appname\ will comply with its requirements. This includes reviewing of application UI \& UX standpoint and choice of applications architecture


\section{Wireframes}

\subsection{Navigation Principle}
How user will be able to navigate through your applications different screens and section is one of most important choices when developing a mobile applications. Material Design describes 3 types of navigation hierarchies that can be used for a top-level navigation

\begin{itemize}
	\item Bottom navigation bar -- Bottom navigation bars provide access to 2-5 top-level destinations on mobile devices. Their location, visibility, and persistence across screens allow quick pivoting between destinations.
	\item Navigation drawer -- Navigation drawers are appropriate for five or more top-level destinations, and can be used across device sizes for a consistent navigation experience.
	\item Tabs -- Tabs can be used at any level of an application's hierarchy to present two or more peer sets of data across screen sizes.
\end{itemize}

\appname\ application has 4 main independent sections: My Library, Sharing Hub, Challenges and Profile making the Bottom Navigation bar the perfect choice. It will enable quick and persistent navigation between different sections.

\subsection{Top-level sections}
Following application sections are used for top level navigation. They must provide access to application core functionalities



\textbf{My Library} section covers note-taking service part of the application. Its entry point contains a list of Notebooks and provides different actions related to the notebook management, such as: Notebook creation, edition, deletion and sharing. By clicking on one of the notebooks in the list, user will be transferred to the Notes subsection, that will contain a list of notes from this notebook. Like Notebooks section, Notes section covers all the note management related actions and interactions such as Note creation, edition and deletion.
